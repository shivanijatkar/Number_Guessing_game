...
import time
number=random.randint(1, 50) #pick the number between 1 and 200
...
def pick():
    ...
    while guessesTaken < 6: #if the number of guesses is less than 6
        ...
        try: #check if a number was entered
            ...
            if guess<=50 and guess>=1: #if they are in range
            ...
            if guess>50 or guess<1: #if they aren't in the range
                print("Oh no! That number isn't in the range!")
                time.sleep(.25)
    ...
    if guess == number:
        ...
        print('Good job, you are brilliant ! You guessed my number in ' + guessesTaken + ' guesses!')
